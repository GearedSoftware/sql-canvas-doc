...
select t.table_name as table_name,
       ...
       case when c.extra = 'auto_increment' then 1 else 0 end as is_auto_increment,
...
select fks.constraint_name, 
       ...
       group_concat(kcu.referenced_column_name order by position_in_unique_constraint separator ', ') as primary_columns
